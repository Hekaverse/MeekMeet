...
import { Mail, ArrowLeft, Loader2, Lock, UserCog } from "lucide-react";
      ...
      >
        ...
        {isMagicLinkSent ? (
          ...
          <div className="bg-cream-warm rounded-3xl border border-border-soft p-8 space-y-6">
            ...
            {/* Magic Link / Review Login */}
            <form onSubmit={showReviewLogin ? handleReviewLogin : handleMagicLink} className="space-y-3">
              ...
              >
                {isLoading ? (
                  <>
                    ...
                    {showReviewLogin ? "Signing in..." : "Sending..."}
                  </>
                ) : showReviewLogin ? (
                  "Reviewer Sign In"
                ) : (
            ...
            <button
              ...
              type="button"
              className="w-full flex items-center justify-center gap-2 py-2 text-xs text-charcoal-muted hover:text-charcoal transition-colors"
            >
