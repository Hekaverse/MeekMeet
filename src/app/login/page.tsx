      ...
      >
        ...
        <div className="bg-cream-warm rounded-3xl border border-border-soft p-8 space-y-6">
          ...
          <div className="space-y-3">
            ...
            <button className="w-full py-3 bg-midnight text-cream rounded-full hover:bg-midnight-soft transition-all duration-300 text-sm tracking-wide font-medium">
              Send Magic Link
            </button>
          </div>
          ...
          {/* OAuth */}
          <button className="w-full flex items-center justify-center gap-3 py-3 border-2 border-charcoal/10 rounded-full hover:border-terracotta hover:text-terracotta transition-all duration-300 text-sm text-charcoal">
